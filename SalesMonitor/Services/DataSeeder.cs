...
namespace SalesMonitor.Services
{
    public class DataSeeder
    {
        ...
        public async Task SeedAsync()
        {
            ...
            var p1 = new Product { Name = "Кофе в зернах", CostPrice = 350, SellingPrice = 500, IsOnSale = true, DateAdded = DateTime.Today.AddMonths(-6), PlanSales = 30000 };
            var p2 = new Product { Name = "Молоко 3,2%", CostPrice = 55, SellingPrice = 80, IsOnSale = true, DateAdded = DateTime.Today.AddMonths(-4), PlanSales = 15000 };
            var p3 = new Product { Name = "Хлеб цельнозерновой", CostPrice = 30, SellingPrice = 50, IsOnSale = false, DateAdded = DateTime.Today.AddMonths(-3), PlanSales = 10000 };
